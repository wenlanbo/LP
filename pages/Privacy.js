            ...
            <Container>
                <div className="relative mx-auto flex min-h-screen w-full flex-wrap items-center ">
                    ...
                    <div className="mb-3">
                        ...
                        <Paragraph className="mb-2">
                            You accept the terms of this Privacy Policy when you sign up for, access, or use any product, service, content, features, technologies or functions offered on the Anicca website.
                            By using our Services, interacting with us, submitting information to us, you are also consenting to our collection, use, disclosure and retention of your personal information as described in this Privacy Policy and in our Terms of Service.
                            You may withdraw your consent to any use of your Personal Information as set out in this Privacy Policy by contacting us at info@anicca.website. However, please note that we may have to decline to offer you certain Services if you withdraw your consent.

                        </Paragraph>
                    </div>

                    <div className="mb-3">
                        <H2 className="mb-3">How We Collect Your Personal Information</H2>
                        <Paragraph className="mb-2">
                            In this Privacy Policy, “Personal Information” means any information that can be associated with a specific person and which can be used to identify that specific person (whether from that data alone or from that data in combination with other information that Anicca has access to). We do not consider Personal Information to include information that has been made anonymous or aggregated so that it can no longer be used, whether in combination with other information or otherwise, to identify a specific person.
                    ...
                    <div className="mb-3">
                        <H3 className="mb-3">Information that we collect automatically</H3>
                        <Paragraph className="mb-2">
                    ...
                    <div className="mb-3">
                        <H3 className="mb-3">Information from other sources</H3>
                        <Paragraph className="mb-2">
                    ...
                    <div className="mb-3">
                        <H2 className="mb-3">How We Use Your Personal Information</H2>
                        <Paragraph className="mb-2">
                    ...
                    <div className="mb-3">
                        <H3 className="mb-3">Operate, improve, and personalise our Services</H3>
                        <Paragraph className="mb-2">
                        ...
                        <H3 className="mb-3">Contact you and provide you customer service</H3>
                        <Paragraph className="mb-2">
                            Provide you with customer support in relation to the use of our Services;
                            Contact you via postal mail, email, or phone (including using auto-dialled or pre-recorded messages and text messages) in order to provide you with information regarding your listings, sales, purchases or payment transactions, poll your opinions, and for such other purposes as authorised by law and is consistent with this Privacy Policy.
                        </Paragraph>
                        <H3 className="mb-3"> Detect, prevent and mitigate fraudulent or illegal activities</H3>
                        <Paragraph className="mb-2">
                        ...
                        <H3 className="mb-3"> Assess your suitability as a candidate for employment</H3>
                        <Paragraph className="mb-2">
                    ...
                    <div className="mb-3">
                        <H2 className="mb-3">How We Share Your Personal Information With Other Third Parties</H2>
                        <Paragraph className="mb-2">
                        ...
                        <Paragraph className="mb-2">
                            Companies that we plan to merge with or acquire or are acquired by. (Should such a combination occur, we will require that the new combined entity follow this Privacy Policy with respect to your Personal Information. If your Personal Information could be used contrary to this policy, you will receive prior notice.)
                    ...
                    <div className="mb-3">
                        <H2 className="mb-3">You May Access and Correct Your Personal Information</H2>
                        <Paragraph className="mb-2">
                    ...
                    <div className="mb-3">
                        <H2 className="mb-3">Storage, Security and Retention of Your Personal Information</H2>
                    </div>
